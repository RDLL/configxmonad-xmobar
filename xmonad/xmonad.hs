...
myTerminal :: String
myTerminal = "mate-terminal"   -- Sets default terminal
...
myEditor :: String
myEditor = "pluma"  -- Sets emacs as editor for tree select
...
myClickableWorkspaces = clickable . (map xmobarEscape)
               -- $ [" 1 ", " 2 ", " 3 ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " 9 "]
               $ [" dev ", " web ", " sys ", " doc ", " vbox ", " chat ", " mus ", " vid ", " gfx "]
  where
...
myKeys home =
    ...
    --Shutdown
        , ("M-p", spawn (myTerminal ++ "shutdown -h now"))
